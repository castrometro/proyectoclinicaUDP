        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <p className="flex items-center">
              ...
              <span className="font-semibold mr-2">Correo:</span> {selectedPatient.correoElectronico}
            </p>
            <p className="flex items-center">
              <Phone size={16} className="mr-2 text-gray-500" />
              <span className="font-semibold mr-2">Teléfono:</span> {selectedPatient.telefono}
            </p>
            <p className="flex items-center">
