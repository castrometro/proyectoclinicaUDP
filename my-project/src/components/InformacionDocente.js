      ...
      {selectedTeacher ? (
        <div>
          <div className="flex justify-between items-center mb-4">
            <p className="text-lg font-medium">{selectedTeacher.nombre}</p>
          </div>
          <div className="space-y-2">
            <p className="flex items-center">
              <User size={16} className="mr-2 text-gray-500" />
              <span className="font-semibold mr-2">RUT:</span> {selectedTeacher.rut}
            </p>
            <p className="flex items-center">
              <GraduationCap size={16} className="mr-2 text-gray-500" />
              <span className="font-semibold mr-2">Especialidad:</span> {selectedTeacher.especialidad}
            </p>
            <p className="flex items-center">
              <Mail size={16} className="mr-2 text-gray-500" />
              <span className="font-semibold mr-2">Correo:</span> {selectedTeacher.correoElectronico}
            </p>
            <p className="flex items-center">
